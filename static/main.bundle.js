...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(59);
/* global window */
...
var store = exports.store = (0, _redux.createStore)(_reducer2.default, (0, _redux.applyMiddleware)(logger), (0, _redux.applyMiddleware)(_reduxThunk2.default));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    'Hello - ',
                    this.props.working ? 'working' : 'not working'
                ),
                _react2.default.createElement(
                    'button',
                    { onClick: function onClick() {
                            return _this2.props.setWorking();
                        } },
                    'Working'
                )
            );
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        setWorking: function setWorking() {
            dispatch((0, _actions.setWorking)());
        }
    };
};
...
var setWorking = exports.setWorking = function setWorking() {
    return function (dispatch) {
        dispatch({
            type: 'SET_WORKING'
        });
